...
<page backtop="7mm" backbottom="7mm" backleft="11mm" backright="10mm" style="font-size: 9px; font-weight: normal; color:#000033;">
	...
	<table cellspacing=0 cellpadding=0 border=0>
		<tr>
			<td width=140 class=cp><img src="dist/img/logosicredi.jpg" alt="Sicredi" width="150" height="27"></td>
			<td width=3 valign=bottom><img height=22 src=dist/img/3.png width=2></td>
		...
		<tr><td colspan=5><img height=1 src=dist/img/2.png width=666></td></tr>
	</table>
	<table cellspacing=0 cellpadding=0 border=0>
		<tr>
			<td width=7 height=1><img src=dist/img/1.png width=7 height=1></td>
			<td width=112><img src=dist/img/1.png width=112 height=1></td>
			<td width=7><img src=dist/img/1.png width=7 height=1></td>
			<td width=113><img src=dist/img/1.png width=113 height=1></td>
			<td width=7><img src=dist/img/1.png width=7 height=1></td>
			<td width=53><img src=dist/img/1.png width=53 height=1></td>
			<td width=7><img src=dist/img/1.png width=7 height=1></td>
			<td width=53><img src=dist/img/1.png width=53 height=1></td>
			<td width=7><img src=dist/img/1.png width=7 height=1></td>
			<td width=113><img src=dist/img/1.png width=113 height=1></td>
			<td width=7><img src=dist/img/1.png width=7 height=1></td>
			<td width=180><img src=dist/img/1.png width=180 height=1></td>
		</tr>
		<tr>
			<td height=13><img src=dist/img/1.png width=1 height=13></td>
			<td colspan=7 class=ct>Cedente</td>
			<td><img src=dist/img/1.png width=1 height=13></td>
			<td class=ct>Agência/Código do Cedente</td>
			<td><img src=dist/img/1.png width=1 height=13></td>
			<td class=ct>Vencimento</td>
		</tr>
		<tr>
			<td height=12><img src=dist/img/1.png width=1 height=12></td>
			<td colspan=7 class=cp><?php echo $dadosboleto["cedente"]?></td>
			<td><img src=dist/img/1.png width=1 height=12></td>
			<td class=cp><?php echo $dadosboleto["agencia_codigo"]?></td>
			<td><img src=dist/img/1.png width=1 height=12></td>
			<td class=cp align=right><?php echo $dadosboleto["data_vencimento"]?></td>
		</tr>
		<tr><td colspan=12 height=1><img src=dist/img/2.png width=666 height=1></td></tr>
		<tr>
			<td height=13><img src=dist/img/1.png width=1 height=13></td>
	...
	<table cellspacing=0 cellpadding=0 border=0>
		...
		<tr><td colspan=4><img src=dist/img/6.png width=665 height=1></td></tr>
	</table>
	&nbsp;<br>
	<table cellspacing=0 cellpadding=0 border=0>
		<tr>
	...
	<table cellspacing=0 cellpadding=0 border=0 height="2">
		<tr>
			<td width=7 height=1><img src=dist/img/2.png width=7 height=1></td>
			<td width=100><img src=dist/img/2.png width=100 height=1></td>
			<td width=7><img src=dist/img/2.png width=7 height=1></td>
			<td width=74><img src=dist/img/2.png width=74 height=1></td>
			<td width=7><img src=dist/img/2.png width=7 height=1></td>
			<td width=73><img src=dist/img/2.png width=73 height=1></td>
			<td width=7><img src=dist/img/2.png width=7 height=1></td>
			<td width=55><img src=dist/img/2.png width=55 height=1></td>
			<td width=7><img src=dist/img/2.png width=7 height=1></td>
			<td width=35><img src=dist/img/2.png width=35 height=1></td>
			<td width=7><img src=dist/img/2.png width=7 height=1></td>
			<td width=100><img src=dist/img/2.png width=100 height=1></td>
			<td width=7><img src=dist/img/2.png width=7 height=1></td>
			<td width=180><img src=dist/img/2.png width=180 height=1></td>
		</tr>
		<tr>
			<td height=13><img src=dist/img/1.png width=1 height=13></td>
		...
		<tr>
			<td height=12><img src=dist/img/1.png width=1 height=12></td>
			<td colspan=11 class=cp>PAGÁVEL PREFERENCIALMENTE NAS COOPERATIVAS DE CRÉDITO DO Sicredi</td>
			<td><img src=dist/img/1.png width=1 height=12></td>
			<td class=cp align=right><?php echo $dadosboleto["data_vencimento"]?></td>
		</tr>
		<tr><td colspan=14 height=1><img src=dist/img/2.png width=666 height=1></td></tr>
		<tr>
			<td height=13><img src=dist/img/1.png width=1 height=13></td>
	...
	<table cellspacing=0 cellpadding=0 border=0>
		<tr>
			<td width=7 height=26><img src=dist/img/1.png width=1 height=26></td>
			...
			<td width=7><img src=dist/img/2.png width=1 height=26></td>
			<td width=180 class=ct>(-) Desconto / Abatimentos</td>
		</tr>
		<tr><td height=1><img src=dist/img/2.png width=1 height=1></td><td><img src=dist/img/2.png width=7 height=1></td><td><img src=dist/img/2.png width=180 height=1></td></tr>
		<tr>
			<td height=26><img src=dist/img/1.png width=1 height=26></td>
			<td><img src=dist/img/2.png width=1 height=26></td>
			<td class=ct>(-) Outras deduções</td>
		</tr>
		<tr><td height=1><img src=dist/img/1.png width=1 height=1></td><td><img src=dist/img/2.png width=7 height=1></td><td><img src=dist/img/2.png width=180 height=1></td></tr>
		<tr>
			<td height=26><img src=dist/img/1.png width=1 height=26></td>
			<td><img src=dist/img/2.png width=1 height=26></td>
		...
		<tr><td colspan=4 height=1><img src=dist/img/2.png width=666 height=1></td></tr>
		<tr>
			<td height=13><img src=dist/img/1.png width=1 height=13></td>
			<td class=ct>Sacado</td>
			<td><img src=dist/img/b.png width=1 height=1></td>
			<td><img src=dist/img/b.png width=1 height=1></td>
		</tr>
		<tr>
			<td height=39><img src=dist/img/1.png width=1 height=39></td>
			<td class=cp><?php echo $dadosboleto["sacado"] . '<br>' . $dadosboleto["endereco1"] . '<br>' . $dadosboleto["endereco2"]?></td>
			<td valign=bottom><img src=dist/img/1.png width=1 height=13></td>
	...
	<table cellspacing=0 cellpadding=0 border=0>
		...
		<tr><td colspan=2 height=1><img src=dist/img/6.png width=665 height=1></td></tr>
	</table>	
</page>        